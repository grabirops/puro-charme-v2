...
jQuery(document).ready(function ($) {
  ...
  if ($map.length) {
    $map.gMapResp({
      address: "9GJ3+JF Conj. Hab. Mal. Mascarenhas de Morais, São Paulo - SP",
      zoom: 9,
      controls: false,
      scrollwheel: false,
      styles: [{ stylers: [{ hue: "#e32c2e" }] }],
      markers: [
        {
          address:
            "9GJ3+JF Conj. Hab. Mal. Mascarenhas de Morais, São Paulo - SP",
          html: "IamDesigning HeadOffice, Coimbatore.",
          icon: {
            image: "js/images/mapicon.png",
            iconsize: [50, 75],
    ...
    $(this).one("inview", function (event, visible) {
      if (visible === true) {
        ...
        if ($(this).attr("data-fgcolor") !== "")
          fgcolor = $(this).attr("data-fgcolor");
        else fgcolor = "#959595";
  ...
  if (jQuery(".dt-sc-testimonial-carousel-wrapper").length) {
    jQuery(".dt-sc-testimonial-carousel").each(function () {
      var pagger = jQuery(this)
          .parents(".dt-sc-testimonial-carousel-wrapper")
          .find("div.carousel-arrows"),
  ...
  if ($(".dt-sc-carousel").length) {
    $(".dt-sc-carousel").each(function () {
      var pagger = $(this)
          .parents(".dt-sc-carousel-wrapper")
          .find("div.carousel-arrows"),
        next = pagger.find("a.testimonial-next"),
        prev = pagger.find("a.testimonial-prev");
  ...
  jQuery(".dt-sc-toggle").on("click", function () {
  ...
  jQuery(window).load(function () {
    ...
    if (!$(".dt-sc-portfolio-container").hasClass("portfolio-horizontal")) {
      ...
      if (
        $container.parents("#primary").find("div.dt-sc-sorting-container")
          .length
      ) {
        $container
          .parents("#primary")
          .find("div.dt-sc-sorting-container a")
          .on("click", function () {
  ...
  function animateSkillBars() {
    var applyViewPort = $("html").hasClass("csstransforms")
      ? ":in-viewport"
      : "";
...
jQuery(function ($) {
  (function () {
    ...
    $(document).on("mousedown touchstart", "[data-decrease]", function () {
      ...
      function decrease() {
        if (
          ($element.attr("min") === undefined ||
            value > parseInt($element.attr("min"), 10)) &&
          ($element.data("min") === undefined ||
            value > parseInt($element.data("min"), 10))
        ) {
          value -= 1;
          $element.val(value);
        }
  ...
  (function () {
    ...
    $(document).on("mousedown touchstart", "[data-increase]", function () {
      ...
      function increase() {
        if (
          ($element.attr("max") === undefined ||
            value < parseInt($element.attr("max"), 10)) &&
          ($element.data("max") === undefined ||
            value < parseInt($element.data("max"), 10))
        ) {
          value += 1;
          $element.val(value);
        }
